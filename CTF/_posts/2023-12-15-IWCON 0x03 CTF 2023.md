...
tags: [web, api, jwt, jwt-jku, python-flask, weak-parser, misc, s3, aws, s3scanner, entropy-scan, tartufo, cve-2022-25012, weak-encryption, cyberchef]
---
...
![](/assets/obsidian/121b21f0e79d827b5c96c8aa03e804a0.png){:target='_blank'}

Requesting token for  `iwcon` returns `Try harder`, so we need to forge its token

![](/assets/obsidian/45561e2b91aabd8632c22ea2b219a1bd.png){:target='_blank'}
...
![](/assets/obsidian/39390124281f5cf40a64ef82f867abad.png){:target='_blank'}

Follow the section : `SELF SIGNED JWT WITH JKU HEADER INJECTION` from this [writeup](https://infosecwriteups.com/jwt-json-web-tokens-explanation-exploitation-0x02-cea23008314f){:target='_blank'}
...
![](/assets/obsidian/63386d0ec6b126bc70901d6b5137ae95.png){:target='_blank'}
...
Use the method to bypass weak parsers by **Orange Tsai** ([Presentation LINK]([Blackhat A-New-Era-Of-SSRF-Exploiting-URL-Parser-In-Trending-Programming-Languages.pdf](https://www.blackhat.com/docs/us-17/thursday/us-17-Tsai-A-New-Era-Of-SSRF-Exploiting-URL-Parser-In-Trending-Programming-Languages.pdf){:target='_blank'}))
...
![](/assets/obsidian/b6a32fa5fa1491eb0557a67faf8656a6.png){:target='_blank'}
...
Hint: [CVE-2022-25012](https://github.com/deathflash1411/cve-2022-25012){:target='_blank'}
...
![](/assets/obsidian/a46af15c845c8605f21b1c787011ea62.png){:target='_blank'}

Google : `CVE-2022-25012`

> https://github.com/s3l33/CVE-2022-25012

![](/assets/obsidian/79bf32904140edc61d38f964082cd167.png){:target='_blank'}
...
[javascript.zip](https://into-the-shadows.s3.eu-north-1.amazonaws.com/javascript.zip){:target='_blank'}
...
![](/assets/obsidian/26cd8a2869e7a59dcc2395f435b0a1aa.png){:target='_blank'}
