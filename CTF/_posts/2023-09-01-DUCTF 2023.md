...
![](/assets/obsidian/3d15e60ec36724f1d050597b9af5c166.pdf)


## Statistics

![](/assets/obsidian/6fc96b8b27e31f1a588b7f774cce6674.png)

![](/assets/obsidian/03f21e2c5ec6e1a26c6f9384fda916fe.png)


## My Solves

![](/assets/obsidian/6c6817a6804ff3c12cd4a3e64937219b.png)
...
> ![](/assets/obsidian/334c00b7902b3fb8cc4c116d3c6e4bdf.png)
{: .prompt-tip }

![](/assets/obsidian/852bbae7ed0cf860917fc60d77932cf2.png)

Google Map : `29.509536 S, 153.359572 E`

It is near to `Durrangan Lookout`

![](/assets/obsidian/35614c622049cf9fd9597bc73d43066f.png)
...
![](/assets/obsidian/5e98985f40bfb161fd9cf4aea58ca632.png)

- The API

![](/assets/obsidian/277a34db3fe0442928e86cb0505d1473.png)
...
![](/assets/obsidian/6b0958d448819874f2b64a9f3a05947c.png)
...
![](/assets/obsidian/4ee70747f6070e248103c3e8d8563a25.png)
...
![](/assets/obsidian/1ae03762d45f671c6514bd381fe8144b.png)
...
![](/assets/obsidian/8365f4df9c25c4023739d180f59ca2cc.png)
...
![](/assets/obsidian/f4b69077ab26e715568c74919a081688.png)
...
![](/assets/obsidian/816ad46e10fb383b6cd5d6a797a9dda1.png)

#### Solve

- Noticed the number on top of the building might be `1800` or `1866`

![](/assets/obsidian/1138716fa70cee399fc8e4c3e1cc2450.png)

Google reverse image search

![](/assets/obsidian/c700abc999638a999b7e2e86c8a016a0.png)

Looks like `1866` is the only one which matches

![](/assets/obsidian/2e566576a4d901327ade2dd6a3e99003.png)

The house at `Maldon` is very much alike

![](/assets/obsidian/853ed4ad5b3c125495c87815efd0567f.png)

![](/assets/obsidian/29de13bdfc63263f5b506c674d44bae1.png)
...
> ![](/assets/obsidian/8d2e576c1a28831c712d4db523788a93.png)
{: .prompt-tip }
...
> > app.py
> ![](/assets/obsidian/a55d24d0756d85c6869319ba9d02bf81.png)
{: .prompt-tip }
...
![](/assets/obsidian/276a84f1c4354ca01ca13e9ecc4aeb9e.png)
...
![](/assets/obsidian/1130c4dd8ce3acc96ab1e97d6c765d3f.png)
...
![](/assets/obsidian/ca83a46e82807d0b741bf4ca1854fb21.png)
...
![](/assets/obsidian/0f9413fcfd11b80700e50aa5021d14b0.png)

In the singup endpoint, user can control what key and values to be added to server signed JWT token upon signing up

> route.py

![](/assets/obsidian/cbfe3978f7803828a2e3f2313e6608c9.png)

JWT token that has `is_teacher` key will be able to view the flag

> auth.py

![](/assets/obsidian/d0e1cb98b1fd159486b2b6334a1139b2.png)

> routes.py

![](/assets/obsidian/f7eabd6808cec10ff8729a5fbded0ff7.png)

Sign up and add `is_teacher` to form data

![](/assets/obsidian/26ba21d7bda61c5f8d4ace53b29e6476.png)

![](/assets/obsidian/7da350fa99e2474d512e5764e7bdd8d9.png)
...
![](/assets/obsidian/8c021d77a2ad66506c41c97862192b7b.png)

But there's a proxy in front of it that will replace `X-Forwarded-For` to client's real IP

![](/assets/obsidian/616e857638d4da6c8260a798e02bc13f.png)

![](/assets/obsidian/643d75da68b3b391c176957c106e7318.png)

![](/assets/obsidian/f388d3843a973fb0e0c20ad7ba6ffa24.png)
...
![](/assets/obsidian/bb7856606878390d1808a9a968af2a4b.png)
...
![](/assets/obsidian/993d571f6727ce5a78b3d971dde217d3.png)

![](/assets/obsidian/8427f06553d44e1903d208ca34075238.png)

I try to read files instead

Press `h` to enter `less`

![](/assets/obsidian/cacfeb3ade63a6d571fd05c9d288ae0d.png)

![](/assets/obsidian/ff45c79d3b75ac082514305a43b55426.png)
...
![](/assets/obsidian/a38cdb33e8a6177a51b83981d55f0238.png)

Then I input `:e` to examine another file

![](/assets/obsidian/7adc9787a4c4fc9aeb22b043cd961f4d.png)

Confirmed that it worked

![](/assets/obsidian/44a37a81e47122619397232f02098f4d.png)

Next, get the flag

![](/assets/obsidian/81a57a78be18a05c694171fac738d231.png)

![](/assets/obsidian/28734b14ff9fa1e776e53110ec05e977.png)
...
![](/assets/obsidian/5557b3e5c93ba46a52f591da8fca9881.png)
...
![](/assets/obsidian/e63c20708e9556d8a88347ecfc664798.png)

- Installed programs at `2023-08-26`

![](/assets/obsidian/0c51c1c6cee53180b7fad4bef0109abb.png)

- Users

![](/assets/obsidian/21738f9878ceb3f11886974e84860847.png)

###### Explore Timelines

Filter timeline at `2023-08-26`, and make sure to select `GMT/UTC`

![](/assets/obsidian/d0c060b5ce216b89edc43dd7ed5975bb.png)

![](/assets/obsidian/6f181a0eafa455a96793a4ff33d8a38e.png)

User `masha.solovyov` was using windows search during `05:00`~`06:00` based on thumbail

![](/assets/obsidian/ab17f1fa514d1663b2e9f790f1ba7569.png)

During `15:00`~`16:00` , a third party program `VSA X` was used, and it's related to **Nmap**

![](/assets/obsidian/bece230c6dc719ec87a676c8fbcf2a7c.png)

###### Search for keywords

Search for `nmap`

![](/assets/obsidian/8089afcf5ad5d7c11787026dc675832b.png)

Sort by modified time and focus at `2023-08-26`, found a db file which contains `nmap` scan data

![](/assets/obsidian/73361e61340e949b1d7a6c74ac53f16d.png)

The timestamp matched exactly to `2023-08-26 15:32:20?`

![](/assets/obsidian/1665d96dec1215dbb8fdfec426614d60.png)

Extract `all_args` and got the `ICMP` payload

![](/assets/obsidian/8a34c71d14f72214d1fb04e2da05b743.png)
...
> ```
> 
> ![](/assets/obsidian/53483c1123920669e9376b590c92eb1b.png)
{: .prompt-tip }
...
![](/assets/obsidian/16dce131ef3e8ba50589e50de8aa12ce.png)
...
![](/assets/obsidian/8e86b7017a41b9415907809232822004.png)
...
![](/assets/obsidian/dfebbfb52424f21ef3fd518a6c33d4a9.png)

Failed Logons

![](/assets/obsidian/b31ec81d28488d09dc2e34a64abf1407.png)
...
![](/assets/obsidian/05af1353ea470e8c51cf7bbae6edbd1e.png)

![](/assets/obsidian/d29594b4ce3796b0d1f204a6d1b5cd50.png)
...
![](/assets/obsidian/a0289fa099cd9332bfbeba6c0cddecba.png)
...
![](/assets/obsidian/9fe24671ac5e3e504eb3d879ecaee570.png)
...
![](/assets/obsidian/75d2b4399d3365cfceb95b41a3735f6a.png)
