...
![](/assets/obsidian/ce8cd7bac84e8b1016a4edbb4ebd64f3.png)

**Personal Score**

![](/assets/obsidian/b4a96ffd373449cbd821227795dbdc83.png)

**Personal Solves**

![](/assets/obsidian/5fb2d2c13ee5e0fd9d93239f0dcb1dad.png)
...
![](/assets/obsidian/1f20143df1385f385c52924f7c6011a1.png)

### Solve

**Wireshark** -> `Statistics -> Protocol Hierarchy`

![](/assets/obsidian/1f7f6852dee19843ba2a03f490a238a1.png)

FTP looks interesting, filter it

![](/assets/obsidian/a73ca97439b689459d05bcdedebc5d2c.png)

Password found

![](/assets/obsidian/771d0479350bc09e752cc5216c7b90e0.png)

![](/assets/obsidian/388a2851897515658ee715d0efe92581.png)
...
![](/assets/obsidian/c1cc0daa6c88836cbcc1a5e66c87543b.png)
...
![](/assets/obsidian/0b37d66e142c9bc9006d64085373c0bf.png)

The IP of SMTP server is `192.168.125.132`

`0xM4hm0ud@example.com` sent mail from `192.168.125.1`

![](/assets/obsidian/167fbce5ce903e84cb4f8b7e4a4fefeb.png)

![](/assets/obsidian/93a352459baf87d7f511f1e1a0d38cfb.png)

Then he sent an image

![](/assets/obsidian/981648f6c69eab1a9e7958a2ef3662b4.png)

`Cryptocat` responded `0xM4hm0ud` with an image from `192.168.125.1` as well

![](/assets/obsidian/82ffdfe5644d89bd9a8a9a666b8fb00c.png)
...
![](/assets/obsidian/dac739f0afa9f892b8bcf728a68f10c6.png)
...
![](/assets/obsidian/db630c9bbc32e041321df2fdbff79460.png)

## Twitter

![](/assets/obsidian/e9578f31e7d9032dc3a17f0a98e1d5f0.png)

## Reddit

Google : `site:reddit.com intigriti`

![](/assets/obsidian/3194e8c31c89a6d1eb11967f58509717.png)
...
![](/assets/obsidian/2544f12e0aeddf6f555b3b6eeff2b8d1.png)
...
![](/assets/obsidian/b66a5586ff28b7033bd2786754367007.png)
...
![](/assets/obsidian/0cdc3aa8cbe5ed83b5c5a64f27f35797.png)
...
![](/assets/obsidian/ceb5c05b682b3b2d794c6a43d426af42.png)

One of my random prompt revealed the AI tech : `OpenAI`

![](/assets/obsidian/945efdfe8bf7e4a2444813eeeb7bd818.png)
...
![](/assets/obsidian/0f5556cd9294bf25d4a44cbe4fc17f1d.png)
...
![](/assets/obsidian/ccc66ba4a6a35df4430d1c740d991f6a.png)
...
![](/assets/obsidian/a6814ef6616b65826b9266e8b9d41978.png)
...
![](/assets/obsidian/07b9a86e4ca0785388f2bf1c89362790.png)
...
![](/assets/obsidian/1ab5ad8e557e0b7689d5158b9411c577.png)
...
![](/assets/obsidian/4f5a312ce4eb9a043c2304f0823d40a7.png)
...
![](/assets/obsidian/8487352225f032bf34187c396d375db0.mp4)

##### Method 2 - Find the address that holds X or Y value

> This method may fail sometimes, use jump method when it's possible

![](/assets/obsidian/3389e3f684aae0515d0a4b818a066fc1.png)

Video demo, found `X` or `Y` then teleport out

![](/assets/obsidian/860da1c75bc0032ddddbcf4f7ee0dcba.mp4)
...
![](/assets/obsidian/b339d7abe761f2c48c3c56c6d2ae3dce.png)
...
![](/assets/obsidian/5117f6ad23685658a98b070f948da25f.png)
...
![](/assets/obsidian/888522d0165733e90c895c3f3f28d521.png)

`JumpSpeed`'s default value was `10f`, let's change it to **10X**

![](/assets/obsidian/cd40d20eb3b7fb6304182d760155ba67.png)

![](/assets/obsidian/3630152bcfc955976af4325e9420c291.png)

Save it

![](/assets/obsidian/dacbf3e48a055e1f2771ccbf5c13c30f.png)

Now I can jump out of restricted area and see the flag

![](/assets/obsidian/28aaf78e47385013621db5b3476ea96f.gif)


![](/assets/obsidian/52a48c19d8120eb5aae97ed34ae99ed6.png)
...
![](/assets/obsidian/e46ecc4e90ac574b885caaa07cd87b92.png)
...
![](/assets/obsidian/5d871dd9ec5c8bc856f94d83e92a3d8f.png)

The first thing I test was IDOR

![](/assets/obsidian/785a2169fa7e26b9ca384e13072308ff.png)

Index `11` exists but not shown in the page; index `12` doesn't exist

By testing `11 or 1=1`, I know there's SQLI

![](/assets/obsidian/8b9beb5769e9be7b77cecf64a7e4fe87.png)

The backend was using **websocket** for real time data fetching

![](/assets/obsidian/d3236ba1076e1c6e6b06fe23625fff93.png)
...
![](/assets/obsidian/1c95d55bf5f2a7452729ee361cf32a88.png)

It requires `admin` to view the config

![](/assets/obsidian/f510b7df7a38b9ff40d45196cd2579b3.png)

#### Crack and forge JWT

It's using JWT

![](/assets/obsidian/9afa5358fd0bc888a1e52371b56e2393.png)
...
![](/assets/obsidian/6e2e4c8a7dbd5094f718e4b4e8309834.png)
...
![](/assets/obsidian/25a839b4b63ce010fb203f6115724114.png)
...
![](/assets/obsidian/dc49f07ff76241194e082f84967c82e4.png)
...
![](/assets/obsidian/a0f905984169c37460dba6ef4333791f.png)
...
![](/assets/obsidian/1c933ce263464e85ce3bcdca9f4fe06f.png)

Transferring money requires Account UUID

![](/assets/obsidian/47289f984c172bdbbbf864be224730fd.png)

In order to get flag, we'll have to upgrade to premium with `10000` bugs

![](/assets/obsidian/6d938f39bf6fa4b4422b975d612898f9.png)
...
![](/assets/obsidian/8cdffaa5d9507e257e5da9803a95ac78.png)
...
![](/assets/obsidian/0feb0a2bd4cc63dffd5934873dbf7cde.png)
...
![](/assets/obsidian/5478304d31534729e0b0405ec4c845d5.png)

It provides some queries (Searching) and Mutations (Function to update data)

![](/assets/obsidian/94aba2509753d41e2e4d93cb153349c1.png)
...
![](/assets/obsidian/802a4d21116b35bdd7be41a807f487bb.png)
...
![](/assets/obsidian/a94ba9bc9a254c9e2c8ad74453abf9ab.png)

Can't query users

![](/assets/obsidian/20fabffc84126c0466745ec4f14b8206.png)

Can't query other users' info

![](/assets/obsidian/78a341273d3a7ce6aed6a927ce9a014a.png)

Can get more info about current user (`role`)

![](/assets/obsidian/a519903aa23848f303313991b184298a.png)

We can only see our own transactions

![](/assets/obsidian/8be99952210ef74181870990fd15f8d0.png)
...
![](/assets/obsidian/782610f4fa7efd109ade90a692b75e8a.png)

By sending `-10000` to the new user, we get `10000`bugs

![](/assets/obsidian/ff34824628e0ae192bb3db1be4eee2a0.png)

![](/assets/obsidian/2fba0eeaca164b06a2dce0d5cc9fa872.png)

That was because the backend did something like this 

![](/assets/obsidian/289d4ba1882f68946b5cc25c01a18b3e.png)

Now we can upgrade premium to get the flag

![](/assets/obsidian/6a61271464892cf2f1aae3352340a451.png)
...
![](/assets/obsidian/8921f8c69b8092ab03ef969b8d50648f.png)
...
![](/assets/obsidian/f75356d70c65d292fd3f73499e0ee177.png)
...
![](/assets/obsidian/9f14e0a1badc0858e01d117b9d21dc80.png)
...
![](/assets/obsidian/65448751b8c1b558d991dc3a80d93646.png)
...
![](/assets/obsidian/d0a778466c0b551516465d4dfcfb0dba.png)
...
![](/assets/obsidian/148351af4469e14e3aec656e955cb88f.png)

We can input any customer name

![](/assets/obsidian/4cfb919e6a77c0b0ce57220dca9907a1.png)
...
![](/assets/obsidian/ba1d4b4e9bab57be9628de29510ce0c2.png)
...
![](/assets/obsidian/c89f7b75767f0117235cf9a7a86eb17e.png)
...
![](/assets/obsidian/8520338509e3f8c53dff319f97d830c4.png)
...
![](/assets/obsidian/cfd155084df5faf5361c68f2a6e360a9.png)
...
![](/assets/obsidian/5d9e5ca2b8adb1b96f676b0020f119e1.png)
...
![](/assets/obsidian/7e5a2a2055d9281015a1637bf4d7c527.png)
...
![](/assets/obsidian/beedb292dc72b178b79e0f8363a09de9.png)
...
![](/assets/obsidian/db48fb2639b78a40a11482e49be2d6fe.png)
...
![](/assets/obsidian/9408cd66f06db51fa10768e67f669555.png)
...
![](/assets/obsidian/dd39f0e184ff4c284ea2b6e1fea349be.png)

![](/assets/obsidian/23e052814887b0812f8c014d1942d771.png)
...
![](/assets/obsidian/d23be8154605793d219acdf451e7cfee.png)

> Github

![](/assets/obsidian/9055cd4608f43b7945e56f99d352cdf4.png)

- The only interesting thing I found was a key leaked in git commits

![](/assets/obsidian/0c6c646cd3203540e65ab45f5d24a673.png)

![](/assets/obsidian/a6c95776e618ead1c763d1a03d667748.png)
...
![](/assets/obsidian/60982e4ec52648b547723c1a54408b56.png)

Checked all comments in target **Flikr**'s favorite photos, nothing interesting

![](/assets/obsidian/896c29637f9e717a39e05b3967f0cc47.png)

Found a reddit comment by another username which was linked to `fl0pfl0p5`

![](/assets/obsidian/793065a5b62175c627c1c7e5d31e67c2.png)

![](/assets/obsidian/5c3b28f5fcf1cd263e6bd90958fc4c81.png)

#### Dox m4r64r1n3

>https://whatsmyname.app/#

![](/assets/obsidian/725e34637e020dcea5d57cecc7287dc0.png)

Checked Pinterest, Reddit, Roblox, nothing interesting

> Twitter

![](/assets/obsidian/96b4a02cb733df555b80b5532fc3d3ad.png)

> [Google lense Reverse Image Search](https://lens.google.com/)

Found the exact image in a reddit post by `v1ck1v4l3`

![](/assets/obsidian/401ea99dbbd0e0561b7b98707cc8431a.png)

![](/assets/obsidian/2cbc6ff64165b69e95c84b36f341f564.png)
...
![](/assets/obsidian/85b93f1812d19a2f71de67375e98462c.png)

The flag was there

![](/assets/obsidian/1b24097f74878cb71f3c1c5fc495e5df.png)
...
![](/assets/obsidian/407322b121694feaf439110b72d36afe.png)
...
![](/assets/obsidian/ed03850e5738bc2a457ca81742833dd7.png)

### Solve

Used Github Copilot to deobfuscate the code

![](/assets/obsidian/5d68a7a3327beb4738f4384e2387a8d2.png)

![](/assets/obsidian/3f31dcfb43d374bebf8597d035632949.png)

![](/assets/obsidian/3367febb9b662e27ee04eb0d2182c8e2.png)
...
![](/assets/obsidian/cfeecd67faf2f2170a4875a7ab41cf10.png)
...
![](/assets/obsidian/defde254ee6a8db69f323cf94866b75e.png)

Use **dnspy** to decompile it

![](/assets/obsidian/b294c9f121312ad3115a9a52eb3f10c0.png)

![](/assets/obsidian/6aa5cc86c517dbc3c4bee8ecc3b1ee20.png)
...
![](/assets/obsidian/e66ccadde237ef87cb308fe0c405191f.png)
...
![](/assets/obsidian/71016c9def1dc30ad497093b8019c9ca.png)
